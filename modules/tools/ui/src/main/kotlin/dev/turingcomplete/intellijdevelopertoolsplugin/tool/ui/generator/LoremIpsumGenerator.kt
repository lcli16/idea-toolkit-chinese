...
class LoremIpsumGenerator(
  ...
  override fun Panel.buildConfigurationUi() {
    ...
    row {
      checkBox("<html>从标志性开始 <i>Lorem ipsum dolor sit amet…</i></html>")
  ...
  class Factory : DeveloperUiToolFactory<LoremIpsumGenerator> {
    ...
    override fun getDeveloperUiToolPresentation() =
      DeveloperUiToolPresentation(menuTitle = "随机假文（Lorem Ipsum）", contentTitle = "随机假文生成器")
